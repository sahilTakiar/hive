...
public class HiveSparkAppClientFactory {

  protected static final transient Logger LOG = LoggerFactory.getLogger(HiveSparkAppClientFactory.class);
  ...
  public static HiveSparkAppClient createHiveSparkAppClient(HiveConf hiveconf, String sessionId)
          throws Exception {
    ...
    if (master.equals("local") || master.startsWith("local[")) {
      ...
      return LocalHiveSparkAppClient.getInstance(generateSparkConf(sparkConf), hiveconf);
    } else {
      return new RemoteHiveSparkAppClient(hiveconf, sparkConf, sessionId);
    }
  }
